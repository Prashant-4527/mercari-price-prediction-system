...
st.write("Enter listing details to get an AI-suggested price, trained on real Mercari marketplace data.")
...
if st.button("Predict Price"):
    ...
    lower, upper = get_prediction_interval(pred_log, interval_lookup["bin_edges"], interval_lookup["bin_bounds"])
